...
$activity = "administracao nova disciplina";
$usuario = "usuario- ";
...
if(($gravar == true)){
    if(novo_disciplinas($_POST['nome'])){
        ...
        $message = 'Ocorreu um erro no cadastro da disciplina.';
        $message_type = 'danger';
        managerMessage($message, $message_type);
        $_POST['tag'] = false;
    }
            ...
            <div id="content" class="" style="width: 100%; min-width: 320px;">
                ...
                <div id='conteudo-pagina' Class="">
                    ...
                    <?php 
                        ...
                        <?php }
                        if(@$_POST['tag'] == 1){
                             $ultimo_id = visualizar_ultimo_id_disciplina($_POST['nome']);
                             $disciplina = visualizar_disciplina_id($ultimo_id);
                            ?>
                                <div class="form-group pt-4">
