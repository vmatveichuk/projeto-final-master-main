...
if((@$_POST['acao1']=="editar_usuario")){
    if(editarUsuario2($_POST['id'],$_POST['nome'], $_POST['email'],$_POST['cpf'],$_POST['senha'])){
        ...
        $message = 'Ocorreu um erro na edicao do aluno.';
        $message_type = 'danger';
        managerMessage($message, $message_type);
        $_POST['tag'] = false;
    }
                         ...
                         if(!@$_POST['tag']){?>
                            <form class="form" action="" method="post">
                                ...
                                <div class="form-group pt-2 pb-3">
                                    ...
                                    <input id="nome" type="text"  name="email" value="<?=$_POST["email"]?>" class="form-control">
                                </div>
                                <div class="form-group pt-2 pb-3">
                                    <label for="nome"><b>Senha</b></label>
                                    <input id="nome" type="text"  name="senha" value="<?= $_POST["senha"] ?>" class="form-control">
                                </div>
                                <input id="nome" type="hidden"  name="acao1" value="editar_usuario" class="form-control">
                                <input type="hidden" id="usuario-id" name="id" value="<?=$_POST['id']?>"> 
                                <div class="row"  style=" margin-right: 0px;  margin-left: 0px;">
                                    <div class="col-md-6 pb-4">
                                        <button class="btn btn-sm btn-primary btn-block" type="submit">Salvar alterações</button>
                                    </div>
                                    </form>
                                    <div class="col-md-6">
