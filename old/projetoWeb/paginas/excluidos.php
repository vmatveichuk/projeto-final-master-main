<?php
    ...
    $retornoCaixaEntrada = $email->buscarDeletados();
?>
        ...
        <div id="body-main-principal">
            ...
            <div id="principal-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    if (empty($retornoCaixaEntrada)) {
                        echo "<tr>";
                        echo "<td colspan='3'>Caixa de entrada vazia</td>";
                        echo "</tr>";
                    } else {
                        foreach ($retornoCaixaEntrada as $caixaEntrada) {
                            echo "<tr>";
                            echo "<td><a href='email.php?c={$caixaEntrada['codigo']}'>{$caixaEntrada["remetente"]}</a></td>";
                            echo "<td>Assunto : {$caixaEntrada["assunto"]}</td>";
                            echo "<td class='textWrap'>{$caixaEntrada["mensagem"]}</td>";
                            echo "</tr>";
                        }
                    }
                    ?>
