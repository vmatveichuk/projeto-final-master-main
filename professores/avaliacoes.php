...
// }
if (@$_POST['acao1']=="corrigir"){
    confirma_nota_avaliacao($_POST['id-aval'],$_POST['nota']);
}
if (@$_POST['acao1']=="deletar"){
    deletar_avaliacao_id($_POST['id-avali']);
}
            ...
            <div id="content" class="" style="width: 100%; min-width: 320px;">
                ...
                <div id='conteudo-pagina' Class=" mr-3 pt-3 pl-4">
                    <div>
                        ...
                        <form name="voltar" action="/professores/disciplinas" method="post">
                        ...
                        $avalia = lista_avaliacoes_por_disciplina($_POST['disciId'], $_POST['idTurma']);
                                ...
                                <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                                    <div class="row">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                                            ...
                                            <div class="col">
                                                <strong class="text-gray-dark"> <?php echo $aluno['nome']; ?></strong><br>
                                            </div>
                                            <div class="col">
                                                <form class="form" action="" method="post">
                                                    <input type="hidden" id="acao1" name="acao1" value="corrigir"> 
                                                    <input type="hidden" id="acao1" name="nota" value="<?= $avalia['avaliacoes'][$i]['nota']  ?>"> 
                                                    <input type="hidden" id="acao1" name="id-aval" value="<?= $avalia['avaliacoes'][$i]['id']  ?>"> 
                                                    ...
                                                    <input type="int" id="acao1" name="nota" value=""> 
                                                    <button class="btn btn-sm btn-primary" type="submit">Corrigir</button>
                                                </form>
                                            </div>
                                            <div class="col">
                                                <form class="form" action="" method="post">
                                                    ...
                                                    <input type="hidden" id="acao13" name="idTurma" value="<?= $_POST['idTurma']?>">
                                                    <input type="hidden" id="acao13" name="disciId" value="<?= $_POST['disciId']?>">
                                                    <input type="hidden" id="acao1" name="id-avali" value="<?= $avalia['avaliacoes'][$i]['id']  ?>"> 
                                                    <input type="hidden" id="acao13" name="disciNome" value="<?=$_POST['disciNome'] ?>">
                                                     <input type="hidden" id="acao13" name="nome" value="<?= $_POST['nome']?>">
                                            ...
                                            <div class="col">
                                                <form class="form" action="/professores/avaliacoes-editar" method="post">
                                                    <input calss='pt-1 mr-1' type="image" src="/sx/common/assets/icon-editar.png" alt="Submit" width="22px">
                                                    <input type="hidden" id="acao13" name="idTurma" value="<?= $_POST['idTurma']?>">
                                                    <input type="hidden" id="acao13" name="descricao" value="<?=$avalia['avaliacoes'][$i]['descricao'] ?>">
                                                    <input type="hidden" id="acao13" name="data" value="<?=$avalia['avaliacoes'][$i]['data']?>">
                                                    <input type="hidden" id="acao13" name="disciId" value="<?= $_POST['disciId']?>">
                                                    <input type="hidden" id="acao1" name="id-avali" value="<?= $avalia['avaliacoes'][$i]['id']  ?>"> 
                                                    <input type="hidden" id="acao13" name="disciNome" value="<?=$_POST['disciNome'] ?>">
                                                    <input type="hidden" id="acao13" name="nome" value="<?= $_POST['nome'] ?>">
