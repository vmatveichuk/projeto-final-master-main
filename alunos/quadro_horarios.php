...
<body>
    <main>
        <div class="wrapper">
            <?php sidebar_aluno('quadro_de_horarios'); ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php 
                            $aulas = aula_por_dia_aluno('segunda',$aluno['turma_id'] );
                        ...
                        <tr>
                            ...
                            <?php
                            $aulas = aula_por_dia_aluno('terca',$aluno['turma_id'] );
                            if ($aulas['resposta'] != false) {
                                for ($i = 0; $i < $aulas['size-aula']; $i++) {
                                    $turma = pegar_turmas_aluno($aulas['aulas'][$i]['turma-id']);
                                    echo '<td style="text-align: center;">' . $aulas['aulas'][$i]['nome'] . ' - ' . $turma['nome'] . '</br>' . $aulas['aulas'][$i]['inicial'] . ' até ' . $aulas['aulas'][$i]['termino'] . '</td>';
                        ...
                        <tr>
                            ...
                            <?php
                            $aulas = aula_por_dia_aluno('quarta',$aluno['turma_id'] );
                            if ($aulas['resposta'] != false) {
                                for ($i = 0; $i < $aulas['size-aula']; $i++) {
                                    $turma = pegar_turmas_aluno($aulas['aulas'][$i]['turma-id']);
                                    echo '<td style="text-align: center;">' . $aulas['aulas'][$i]['nome'] . ' - ' . $turma['nome'] . '</br>' . $aulas['aulas'][$i]['inicial'] . ' até ' . $aulas['aulas'][$i]['termino'] . '</td>';
                        ...
                        <tr>
                            ...
                            <?php
                            $aulas = aula_por_dia_aluno('quinta',$aluno['turma_id'] );
                            if ($aulas['resposta'] != false) {
                                for ($i = 0; $i < $aulas['size-aula']; $i++) {
                                    $turma = pegar_turmas_aluno($aulas['aulas'][$i]['turma-id']);
                                    echo '<td style="text-align: center;">' . $aulas['aulas'][$i]['nome'] . ' - ' . $turma['nome'] . '</br>' . $aulas['aulas'][$i]['inicial'] . ' até ' . $aulas['aulas'][$i]['termino'] . '</td>';
                        ...
                        <tr>
                            ...
                            <?php
                            $aulas = aula_por_dia_aluno('sexta',$aluno['turma_id'] );
                            if ($aulas['resposta'] != false) {
                                for ($i = 0; $i < $aulas['size-aula']; $i++) {
                                    $turma = pegar_turmas_aluno($aulas['aulas'][$i]['turma-id']);
                                    echo '<td style="text-align: center;">' . $aulas['aulas'][$i]['nome'] . ' - ' . $turma['nome'] . '</br>' . $aulas['aulas'][$i]['inicial'] . ' até ' . $aulas['aulas'][$i]['termino'] . '</td>';
