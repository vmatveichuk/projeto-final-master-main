        ...
        <ul class="list-unstyled components">
            ...
            <li class="<?=$pagina == 'quadro_de_horarios' ? 'active' : '' ?>" style="padding-top: 1px;">
                <a href="/alunos/quadro_horarios">
                    <img src="/sx/common/assets/disciplinas-icon.svg" width="16" height="16" class="" alt="" color="white">
                    &nbsp;&nbsp;<div class="d-inline-flex" style="vertical-align: middle; margin:auto ">Quadro de horarios</div>
                </a>
            </li>
            <li class="<?=$pagina == 'ajuste_academico' ? 'active' : '' ?>" style="padding-top: 1px;">
                <a href="/alunos/ajuste_academico">
                    <img src="/sx/common/assets/disciplinas-icon.svg" width="16" height="16" class="" alt="" color="white">
                    &nbsp;&nbsp;<div class="d-inline-flex" style="vertical-align: middle; margin:auto ">Ajuste academico</div>
                </a>
            </li>
...
?>
    <nav id="sidebar">
        <ul class="list-unstyled components">
            ...
            <li class="<?=$pagina == 'quadro_horarios' ? 'active' : '' ?>" style="padding-top: 1px;">
            ...
            <li class="<?=$pagina == 'envio_documentos' ? 'active' : '' ?>" style="padding-top: 1px;">
                <a href="/professores/avaliacao-adicionar">
                    <img src="/sx/common/assets/avaliacoes-icon.svg" width="16" height="16" class="" alt="">
                    &nbsp;&nbsp;<div class="d-inline-flex" style="vertical-align: middle; margin:auto ">Envio de avaliações</div>
                </a>
            </li>
...
?>
    <nav id="sidebar">
        <ul class="list-unstyled components">
            ...
            <li class="<?=$pagina == 'cursos' ? 'active' : '' ?>" style="padding-top: 1px;">
                <a href="/administracao/cursos">
                    <img src="/sx/common/assets/professores-icon.svg" width="16" height="16" class="" alt="">
                    &nbsp;&nbsp;<div class="d-inline-flex" style="vertical-align: middle; margin:auto ">Cursos</div>
                </a>
            </li>
            ...
            <li class="<?=$pagina == 'usuarios' ? 'active' : '' ?>" style="padding-top: 1px;">
                <a href="/administracao/usuarios">
                    <img src="/sx/common/assets/professores-icon.svg" width="16" height="16" class="" alt="">
                    &nbsp;&nbsp;<div class="d-inline-flex" style="vertical-align: middle; margin:auto ">Usuarios</div>
                </a>
            </li>
